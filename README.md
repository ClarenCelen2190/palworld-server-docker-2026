...
[![Documentation](https://github.com/thijsvanloef/palworld-server-docker/assets/58031337/b92d76d1-5efb-438d-9ffd-5385544a831b)](https://--.loef.dev/)
...
> [base image repo](https://github.com//-arm64).

| Variable                                   | Info                                                                                                                                                                                                | Default Values                                                                                     | Allowed Values                                                                                                                                  | Added in Version |
|--------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|------------------|
| BOX64_DYNAREC_STRONGMEM                     | [[Box64 config](https://.com//box64/blob/main/docs/USAGE.md#box64_dynarec_strongmem-)] Enable/Disable simulation of Strong Memory model                                                    | 1                                                                                              | 0, 1, 2, 3                                                                                                        | 0.23.0           |
| BOX64_DYNAREC_BIGBLOCK                     | [[Box64 config](https://.com//box64/blob/main/docs/USAGE.md#box64_dynarec_bigblock-)] Enables/Disables Box64's Dynarec building BigBlock.                                                    | 1                                                                                              | 0, 1, 2, 3                                                                                                        | 0.23.0           |
| BOX64_DYNAREC_SAFEFLAGS                     | [[Box64 config](https://.com///blob/main/docs/USAGE.md#box64_dynarec_safeflags-)] Handling of flags on CALL/RET opcodes                                                    | 1                                                                                              | 0, 1, 2                                                                                                        | 0.23.0           |
| BOX64_DYNAREC_FASTROUND                     | [[Box64 config](https://.com//box64//main/docs/USAGE.md#box64_dynarec_fastround-)] Enable/Disable generation of precise x86 rounding                                                    | 1                                                                                              | 0, 1                                                                                                        | 0.23.0           |
...
For an official documents go to: [https://..com/category/rest-api](https://tech.palworldgame.com/category/rest-api)
...
> see [supercronic](https://github.com//supercronic#crontab-format)
> or
> [Crontab Generator](https://-generator.org).
...
> [!TIP]
> This image uses Supercronic for crons
> see [supercronic](https://.com/aptible/supercronic#crontab-format)
> or
> [Crontab Generator](https://-.org).
...
> [!TIP]
> This image uses Supercronic for crons
> see [supercronic](https://./aptible/#crontab-format)
> or
> [Crontab Generator](https://-.org).
...
> Check out the [official webpage for the supported parameters.](https://.com/-game-balance)
...
| BAN_LIST_URL                              | Which ban list to use                                                                                                                                            | [https://b.palworldgame.com/api/banlist.txt](https://b..comapi/banlist.txt)     | string                                 |
...
Issues/Feature requests can be submitted by using [this link](https://.com//palworld-server-docker/issues/new/choose).

### Known Issues

Known issues are listed in the [documentation](https://--.loef.dev/known-issues/)
